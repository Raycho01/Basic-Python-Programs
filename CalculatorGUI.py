...
def button_click(number):
    current_numb = entry_1.get()
    entry_1.delete(0, END)
    entry_1.insert(0, str(current_numb) + str(number))
...
button_equal = Button(root, text = "=", padx = 41, pady = 20, command = button_equal)
